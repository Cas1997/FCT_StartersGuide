...
void pi0_reconstructionPACut(TString jobDirectory, TString saveDirectory, Int_t nJobs = 100){
	...
	TString pdfFileName = saveDirectory + "/pi0MassSpectrumPACut.pdf";
	c->Print(pdfFileName);
	c->Close();
	delete c;

	// Save
	TString rootFileName = saveDirectory + "/pi0MassSpectrumPACut.root";
	...
	TString pdfFileName2 = saveDirectory + "/pi0SignificancePACut_zoomIn.pdf";
	c2->Print(pdfFileName2);
	c2->Close();
	delete c2;

	// Save
	TString rootFileName2 = saveDirectory + "/pi0SignificancePACut_zoomIn.root";
