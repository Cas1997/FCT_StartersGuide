...
// ********************************************************************
//
/// \file OptrMultiParticleChangeCrossSection.hh
/// \brief Definition of the OptrMultiParticleChangeCrossSection class
//
//-----------------------------------------------------------------
//
...
//        In the present case, the OptrChangeCrossSection
...
#ifndef OptrMultiParticleChangeCrossSection_hh
#define OptrMultiParticleChangeCrossSection_hh 1

#include "G4VBiasingOperator.hh"
class OptrChangeCrossSection;
class G4ParticleDefinition;

#include <map>

class OptrMultiParticleChangeCrossSection : public G4VBiasingOperator {
public:
  OptrMultiParticleChangeCrossSection();
  virtual ~OptrMultiParticleChangeCrossSection() {}
...
private:
  ...
  std::map < const G4ParticleDefinition*, 
             OptrChangeCrossSection* >    fBOptrForParticle;
  std::vector < const G4ParticleDefinition* >   fParticlesToBias;
  OptrChangeCrossSection*                  fCurrentOperator;
