...
// ********************************************************************
//
/// \file optrChangeCrossSection.hh
/// \brief Definition of the OptrChangeCrossSection class
//
//---------------------------------------------------------------
//
// OptrChangeCrossSection
//
// Class Description:
...
#ifndef OptrChangeCrossSection_hh
#define OptrChangeCrossSection_hh 1
...
class OptrChangeCrossSection : public G4VBiasingOperator {
public:
  // ------------------------------------------------------------
  // -- Constructor: takes the name of the particle type to bias:
  // ------------------------------------------------------------
  OptrChangeCrossSection(G4String particleToBias, G4String name = "ChangeXS");
  virtual ~OptrChangeCrossSection();
