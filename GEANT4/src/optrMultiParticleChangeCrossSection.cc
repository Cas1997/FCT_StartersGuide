...
// ********************************************************************
//
/// \file optrMultiParticleChangeCrossSection.cc
/// \brief Implementation of the OptrMultiParticleChangeCrossSection class
//
...
OptrMultiParticleChangeCrossSection::OptrMultiParticleChangeCrossSection()
  : G4VBiasingOperator("GammaconversionExponentialTransform")
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void OptrMultiParticleChangeCrossSection::AddParticle(G4String particleName)
{
  ...
  if ( particle == 0 )
    {
      ...
      G4Exception("OptrMultiParticleChangeCrossSection::AddParticle(...)",
                  "exGB01.02",
                  JustWarning,
                  ed);
      return;
  ...
  OptrChangeCrossSection* Optr = new OptrChangeCrossSection(particleName);
...
G4VBiasingOperation*
OptrMultiParticleChangeCrossSection::
...
void OptrMultiParticleChangeCrossSection::StartTracking( const G4Track* track )
{
  ...
  std::map < const G4ParticleDefinition*, OptrChangeCrossSection* > :: iterator
